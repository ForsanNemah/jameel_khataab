        ...
        <h1>ما يميزنا </h1>
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">دكاترة مؤهلين </h2>
              <div class="st-iconbox-text">
                
           نفخر بامتلاكنا  كادر من اكبر الاستشارين على مستوى المملكة 
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M64 96c0-35.3 28.7-64 64-64H512c35.3 0 64 28.7 64 64V352H512V96H128V352H64V96zM0 403.2C0 392.6 8.6 384 19.2 384H620.8c10.6 0 19.2 8.6 19.2 19.2c0 42.4-34.4 76.8-76.8 76.8H76.8C34.4 480 0 445.6 0 403.2zM288 160c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v48h48c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H352v48c0 8.8-7.2 16-16 16H304c-8.8 0-16-7.2-16-16V272H240c-8.8 0-16-7.2-16-16V224c0-8.8 7.2-16 16-16h48V160z"/></svg>
              </div>
              <h2 class="st-iconbox-title"> اجهزة حديثة</h2>
              <div class="st-iconbox-text">
                
        نستخدم احدث الاجهزة والتقنيات  لخدمتكم
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title"> بيئة امنة ومريحة </h2>
              <div class="st-iconbox-text">
                
              نحرص على توفير بيئة مريحة وآمنة لعملائنا
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <div class="st-funfact-title">عميل راض</div>
                </div>
                <div class="st-height-b30 st-height-lg-b30"></div>
              </div><!-- .col -->
              <div class="col-lg-6">
          ...
          <div class="col-lg-10 offset-lg-1">
            ...
            <form action="assets/php/mail.php" class="row st-contact-form st-type1" method="post" id="contact-form">
              ...
              <div class="col-lg-12">
                <div class="st-form-field st-style1">
                  <label>رسالتك </label>
                  <textarea cols="30" rows="10" id="msg" name="msg" placeholder="ضع رسالتك هنا "
                    required></textarea>
                </div>
              </div><!-- .col -->
              <div class="col-lg-12">
