        ...
        <h1>ما يميزنا </h1>
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">24 ساعة</h2>
              <div class="st-iconbox-text">
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">خدمة  الطوارئ </h2>
              <div class="st-iconbox-text">
                
           نقدم خدمة الطوارئ عاى مدار 24 ساعة 
                  ...
                  <div class="st-form-field st-style1">
                    ...
                    <div class="st-custom-select-wrap">
                      <select name="udepartment" id="udepartment" class="st_select1"
                        ...
                        <option></option>
                        <option value="dental-care">تجميل</option>
                        <option value="neurology">ليزر</option>
                        <option value="crutches">اسنان</option>
                        <option value="cardiology">اخرى</option>
